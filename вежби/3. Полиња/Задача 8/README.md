...
Да се креира веб страница за закажување термини во берберница. Во текстуално поле се внесува името на клиентот, и преку календар се внесува денот и времето на терминот.
