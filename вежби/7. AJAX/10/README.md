...
- Нa митичките предмети им се додава "mythical" на нивното име, а при визуелното прикажување на нивната слика потребно е да се користи и СЅЅ класата “blue-filter“.
...
1. **Механизам за изработка:**
   ...
   • Дозволување на корисниците да кликаат на слот од таблата за да стават активен предмет.
