...
Направете веб страна каде ќе имате неколку елементи кој при hover со покажувачот, елементите ги снемува и не се гледат повеќе се додека не се остране покажувачот. Напомена, не смее да се менува структурата на страната.
...
<html lang="en">
  ...
  <body>
    <div id="main">
      <!-- Поставување неколку параграфи со произволен текст -->
