...
Една еcommerce фирма и е потребно checkout секција во вебстраната нивна каде што ќе може корисникот да си ја внесе својата плантежна картичка за наплата. Напревете формулар за внесување на плантежна картичка и проверите дали е таа валидна при клик на submit копчето, доколку не е валидна да се прикаже соодветна порака. Плантежна картичка е валидна ако се состои само од цифри и е долга 16 цифри, датумот исто така несмее да биде истечен и CVC е составено само од цифри и долго 3 цифри. (Бонус: валидитирајте ги картичките со Luhn’s algorithm)
